...
(defun epi-build-and-run-cross (args)
  ...
  (interactive (list
                (read-string (format "Args: (%s): " (if (boundp 'epi-args) epi-args "fb"))
                             nil nil (if (boundp 'epi-args) epi-args "fb"))))
  (let ((cmd (concat "ssh -t gene@192.168.0.12 'cd /home/gene/Programming/epimorphism6 && make -j12
 -C build && cp -r lib/epi /home/linaro/root/home/linaro/Programming/epimorphism6/lib' && cd /home/linaro/Programming/epimorphism6 && sudo nice -n -10 ./epimorphism " args)))
