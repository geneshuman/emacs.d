...
(global-set-key (kbd "C-c n") 'noccur-project)
...
(global-set-key (kbd "C-M-1") (lambda()(interactive) (progn
        (select-window shell-window)
        (switch-to-buffer "*vterminal<1>*")
        (redisplay))))

(global-set-key (kbd "C-M-2") (lambda()(interactive) (progn
        (select-window shell-window)
        (switch-to-buffer "*vterminal<2>*")
        (redisplay))))

(global-set-key (kbd "C-M-3") (lambda()(interactive) (progn
        (select-window shell-window)
        (switch-to-buffer "*vterminal<3>*")
        (redisplay))))

(global-set-key  (kbd "C-M-4") (lambda()(interactive) (progn
        (select-window shell-window)
